...
using DanielASG.HelpDesk.MultiTenancy.HostDashboard;
...
namespace DanielASG.HelpDesk.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
            ...
            UsingDbContext(
                context =>
                {
                    ...
                    CreatePaidPayment(context, new SubscriptionPayment
                    {
                        ...
                        {
                            new("Test Payment", 100)
                            {
                                ExtraProperties = new ExtraPropertyDictionary {["EditionId"] = specialEdition.Id}
                            }
                        },
                        DayCount = 365,
        ...
        private void CreatePaidPayment(HelpDeskDbContext context, SubscriptionPayment subscriptionPayment)
        {
                ...
                context =>
                {
                    ...
                    CreatePaidPayment(context, new SubscriptionPayment
                    {
                        SubscriptionPaymentProducts = new List<SubscriptionPaymentProduct>
                        {
                            new("Test payment", 100)
                            {
                                ExtraProperties = new ExtraPropertyDictionary {["EditionId"] = standardEdition.Id}
                            }
                        },
                        CreationTime = date1
                    });
