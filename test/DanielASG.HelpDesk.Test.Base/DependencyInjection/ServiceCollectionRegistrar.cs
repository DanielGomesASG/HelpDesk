...
namespace DanielASG.HelpDesk.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<HelpDeskDbContext>>()
            ...
            new HelpDeskDbContext(builder.Options).Database.EnsureCreated();
        }
