...
namespace DanielASG.HelpDesk.Web.Public.Startup
{
    [DependsOn(
        typeof(HelpDeskWebCoreModule)
    )]
    public class HelpDeskWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public HelpDeskWebFrontEndModule(IWebHostEnvironment env, HelpDeskEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HelpDeskWebFrontEndModule).GetAssembly());
        }
    }
}
