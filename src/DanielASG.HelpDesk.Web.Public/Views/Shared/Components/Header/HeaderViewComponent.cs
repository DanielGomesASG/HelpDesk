...
using DanielASG.HelpDesk.Web.Public.Startup;
using DanielASG.HelpDesk.Web.Session;
using DanielASG.HelpDesk.Web.UiCustomization;

namespace DanielASG.HelpDesk.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : HelpDeskViewComponent
    {
