...
namespace DanielASG.HelpDesk.Core.Base
{
    public abstract class HelpDeskQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected HelpDeskQueryBase(string fieldName,
