...
using DanielASG.HelpDesk.Extensions;

namespace DanielASG.HelpDesk.ApiClient
{
    public class AbpApiClient : ISingletonDependency, IDisposable
    {
        ...
        private void AddHeaders(string accessToken)
        {
            ...
            _client.WithHeader("User-Agent", HelpDeskConsts.AbpApiClientUserAgent);
            ...
            bool stripAjaxResponseWrapper)
        {
            ...
            {
                throw new AbpAuthorizationException(response.Error.Message);
            }
