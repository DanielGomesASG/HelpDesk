...
using DanielASG.HelpDesk.Schemas;
using DanielASG.HelpDesk.Web.Chat.SignalR;
using DanielASG.HelpDesk.Web.Common;
using DanielASG.HelpDesk.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using DanielASG.HelpDesk.Web.Swagger;
using Stripe;
...
using DanielASG.HelpDesk.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using DanielASG.HelpDesk.Web.Extensions;
using DanielASG.HelpDesk.Web.MultiTenancy;
using DanielASG.HelpDesk.Web.OpenIddict;
using SecurityStampValidatorCallback = DanielASG.HelpDesk.Identity.SecurityStampValidatorCallback;
...
namespace DanielASG.HelpDesk.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<HelpDeskWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseHelpDeskForwardedHeaders();
            }
            else
            {
            ...
            if (HelpDeskConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "HelpDesk API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("DanielASG.HelpDesk.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                var applicationXml = $"DanielASG.HelpDesk.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"DanielASG.HelpDesk.Web.Core.xml";
