...
using DanielASG.HelpDesk.UiCustomization.Dto;

namespace DanielASG.HelpDesk.Web.TagHelpers
{
    ...
    public class HelpDeskPageSubheaderTagHelper : TagHelper
    {
        ...
        public HelpDeskPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
