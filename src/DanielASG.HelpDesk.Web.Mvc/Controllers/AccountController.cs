...
using DanielASG.HelpDesk.Net.Sms;
using DanielASG.HelpDesk.Notifications;
using DanielASG.HelpDesk.Web.Models.Account;
using DanielASG.HelpDesk.Security;
using DanielASG.HelpDesk.Security.Recaptcha;
using DanielASG.HelpDesk.Sessions;
using DanielASG.HelpDesk.Url;
using DanielASG.HelpDesk.Web.Authentication.External;
using DanielASG.HelpDesk.Web.Security.Recaptcha;
using DanielASG.HelpDesk.Web.Session;
using DanielASG.HelpDesk.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : HelpDeskControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(HelpDeskConsts.DateTimeOffsetFormat));
