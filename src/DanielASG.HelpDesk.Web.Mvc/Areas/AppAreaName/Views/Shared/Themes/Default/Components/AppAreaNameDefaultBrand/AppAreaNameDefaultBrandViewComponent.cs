...
namespace DanielASG.HelpDesk.Web.Areas.AppAreaName.Views.Shared.Themes.Default.Components.AppAreaNameDefaultBrand
{
    public class AppAreaNameDefaultBrandViewComponent : HelpDeskViewComponent
    {
