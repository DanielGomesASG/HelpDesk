...
namespace DanielASG.HelpDesk.Web.Areas.AppAreaName.Views.Shared.Themes.Theme7.Components.AppAreaNameTheme7Footer
{
    public class AppAreaNameTheme7FooterViewComponent : HelpDeskViewComponent
    {
