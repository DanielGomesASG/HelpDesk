...
namespace DanielASG.HelpDesk.Web.Areas.AppAreaName.Views.Shared.Themes.Theme11.Components.AppAreaNameTheme11Footer
{
    public class AppAreaNameTheme11FooterViewComponent : HelpDeskViewComponent
    {
