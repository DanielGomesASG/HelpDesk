...
namespace DanielASG.HelpDesk.Web.Areas.AppAreaName.Views.Shared.Themes.Theme2.Components.AppAreaNameTheme2Footer
{
    public class AppAreaNameTheme2FooterViewComponent : HelpDeskViewComponent
    {
