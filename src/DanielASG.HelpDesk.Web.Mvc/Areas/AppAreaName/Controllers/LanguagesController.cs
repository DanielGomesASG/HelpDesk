...
using DanielASG.HelpDesk.Web.Areas.AppAreaName.Models.Languages;
...
namespace DanielASG.HelpDesk.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : HelpDeskControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = HelpDeskConsts.LocalizationSourceName;
            }
