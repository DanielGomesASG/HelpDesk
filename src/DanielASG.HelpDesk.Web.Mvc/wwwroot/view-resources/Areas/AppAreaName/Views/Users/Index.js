(function () {
  $(function () {
    ...
    var _excelExportModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaName/Users/ExcelExportModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Users/_ExcelExportModal.js',
              ...
              },
              {
                ...
                visible: function () {
                  return _dynamicEntityPropertyManager.canShow(
                    'DanielASG.HelpDesk.Authorization.Users.User'
                  );
                },
                action: function (data) {
                  _dynamicEntityPropertyManager.modal.open({
                    entityFullName: 'DanielASG.HelpDesk.Authorization.Users.User',
    ...
    $('#ImportUsersFromExcelButton')
      .fileupload({
        url: abp.appPath + 'AppAreaName/Users/ImportFromExcel',
        dataType: 'json',
