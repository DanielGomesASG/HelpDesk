...
using DanielASG.HelpDesk.EntityFrameworkCore.Repositories;

namespace DanielASG.HelpDesk.Organizations
{
    public class UserOrganizationUnitRepository : HelpDeskRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<HelpDeskDbContext> dbContextProvider)
