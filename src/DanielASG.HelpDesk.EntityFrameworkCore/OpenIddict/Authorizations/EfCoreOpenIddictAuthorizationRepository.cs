...
namespace DanielASG.HelpDesk.OpenIddict.Authorizations
{
    public class EfCoreOpenIddictAuthorizationRepository : HelpDeskRepositoryBase<OpenIddictAuthorization, Guid>,
