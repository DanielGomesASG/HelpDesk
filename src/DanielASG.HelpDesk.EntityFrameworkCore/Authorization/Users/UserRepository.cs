...
{
    public class UserRepository : HelpDeskRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<HelpDeskDbContext> dbContextProvider)
