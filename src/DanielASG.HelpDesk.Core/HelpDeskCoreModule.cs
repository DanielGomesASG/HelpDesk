...
using DanielASG.HelpDesk.Authorization.Ldap;
...
namespace DanielASG.HelpDesk
{
    ...
    public class HelpDeskCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            HelpDeskLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = HelpDeskConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, HelpDeskMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<HelpDeskSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HelpDeskCoreModule).GetAssembly());
        }
