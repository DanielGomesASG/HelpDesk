...
/// </summary>
public class HelpDeskSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public HelpDeskSimplePermissionDependency()
    {
    ...
    public HelpDeskSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public HelpDeskSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
