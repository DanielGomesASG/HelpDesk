...
using DanielASG.HelpDesk.Authentication;
...
namespace DanielASG.HelpDesk.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!HelpDeskConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        HelpDeskConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        HelpDeskDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        HelpDeskDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = HelpDeskDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{HelpDeskDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{HelpDeskDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = HelpDeskDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = HelpDeskDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    HelpDeskDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = HelpDeskDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{HelpDeskDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{HelpDeskDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = HelpDeskDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = HelpDeskDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    HelpDeskDashboardCustomizationConsts.Widgets.Tenant
