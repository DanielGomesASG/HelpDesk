        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    {
                        path: 'tickets/standardMessages',
                        loadChildren: () => import('./tickets/standardMessages/standardMessage.module').then(m => m.StandardMessageModule),
                        data: { permission: 'Pages.Register.Tickets.StandardMessages' }
                    },
                
                    
                    {
                        path: 'tickets/messageTypes',
                        loadChildren: () => import('./tickets/messageTypes/messageType.module').then(m => m.MessageTypeModule),
                        data: { permission: 'Pages.Register.Tickets.MessageTypes' }
                    },
                
                    {
                        path: 'tickets/statuses',
                        loadChildren: () => import('./tickets/statuses/status.module').then(m => m.StatusModule),
                        data: { permission: 'Pages.Register.Tickets.Statuses' }
                    },
