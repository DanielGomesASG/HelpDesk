...
import { HelpDeskCommonModule } from '@shared/common/common.module';
...
import { SelectInputTypeModule } from './select-input-type/select-input-type.module';
