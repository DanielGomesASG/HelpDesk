...
using DanielASG.HelpDesk.Authorization.Users.Profile.Cache;
    ...
    public class ProfileAppService : HelpDeskAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("DanielASG.HelpDesk",
