...
namespace DanielASG.HelpDesk.MultiTenancy
{
    ...
    public class TenantAppService : HelpDeskAppServiceBase, ITenantAppService
    {
        ...
        public TenantAppService(TenantBaseDataBuilder tenantBaseDataBuilder)
        {
        ...
        [AbpAuthorize(AppPermissions.Pages_Tenants_ChangeFeatures)]
        public async Task ResetTenantDataBuilder(EntityDto input)
        {
            var tenant = await TenantManager.GetByIdAsync(input.Id);
