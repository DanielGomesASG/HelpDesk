...
{
    public class IncomeStatisticsService : HelpDeskDomainServiceBase, IIncomeStatisticsService
    {
        ...
        {
            var payments = await _subscriptionPaymentRepository.GetAllIncluding(p => p.SubscriptionPaymentProducts)
