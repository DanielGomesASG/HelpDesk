...
namespace DanielASG.HelpDesk.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : HelpDeskAppServiceBase, IDashboardCustomizationAppService
    {
        ...
        public DashboardOutput GetDashboardDefinition(GetDashboardInput input)
        {
            ...
            List<WidgetFilterOutput> GetNeededWidgetFiltersOutput(WidgetDefinition widget)
            {
                ...
                return _dashboardConfiguration.GetWidgetFilterDefinitions()
        ...
        private async Task<Dashboard> GetDefaultDashboardValue(string application, string dashboardName)
        {
            ...
            return string.IsNullOrWhiteSpace(dashboardConfigAsJsonString)
                ? null
                : JsonSerializer.Deserialize<Dashboard>(dashboardConfigAsJsonString);
        }
            ...
            DashboardDefinition dashboardDefinition)
        {
            ...
            var widgetDefinitions = _dashboardConfiguration.GetWidgetDefinitions()
