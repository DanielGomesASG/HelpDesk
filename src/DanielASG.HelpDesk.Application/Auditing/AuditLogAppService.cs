...
using DanielASG.HelpDesk.Auditing.Exporting;
using DanielASG.HelpDesk.Authorization;
using DanielASG.HelpDesk.Authorization.Users;
using DanielASG.HelpDesk.Dto;
using DanielASG.HelpDesk.EntityHistory;
using EntityHistoryHelper = DanielASG.HelpDesk.EntityHistory.EntityHistoryHelper;

namespace DanielASG.HelpDesk.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : HelpDeskAppServiceBase, IAuditLogAppService
    {
