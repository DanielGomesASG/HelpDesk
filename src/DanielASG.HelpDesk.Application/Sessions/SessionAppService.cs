...
using DanielASG.HelpDesk.UiCustomization;
...
{
    public class SessionAppService : HelpDeskAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = HelpDeskConsts.Currency,
                        CurrencySign = HelpDeskConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = HelpDeskConsts.AllowTenantsToChangeEmailSettings,
