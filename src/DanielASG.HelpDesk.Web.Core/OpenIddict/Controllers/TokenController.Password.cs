...
using DanielASG.HelpDesk.Web.OpenIddict.Claims;
using OpenIddict.Abstractions;
using OpenIddict.Server.AspNetCore;

namespace DanielASG.HelpDesk.Web.OpenIddict.Controllers
{
    public partial class TokenController
    {
        ...
        protected virtual async Task<IActionResult> HandlePasswordAsync(OpenIddictRequest request)
        {
            ...
            var signInManager = IocManager.Instance.Resolve<SignInManager>();
        ...
        protected virtual async Task<IActionResult> SetSuccessResultAsync(OpenIddictRequest request, User user)
        {
            var signInManager = IocManager.Instance.Resolve<SignInManager>();
