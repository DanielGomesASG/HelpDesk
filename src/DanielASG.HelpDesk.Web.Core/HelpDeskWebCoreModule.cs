...
using DanielASG.HelpDesk.Authentication.TwoFactor;
...
using DanielASG.HelpDesk.Web.Authentication.JwtBearer;
using DanielASG.HelpDesk.Web.Authentication.TwoFactor;
using DanielASG.HelpDesk.Web.Chat.SignalR;
using DanielASG.HelpDesk.Web.Common;
using DanielASG.HelpDesk.Web.Configuration;
using DanielASG.HelpDesk.Web.DashboardCustomization;
using Abp.Extensions;
using Abp.HtmlSanitizer;
using Abp.HtmlSanitizer.Configuration;
using DanielASG.HelpDesk.Authorization.Accounts;

namespace DanielASG.HelpDesk.Web
{
    [DependsOn(
    ...
    public class HelpDeskWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public HelpDeskWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(HelpDeskApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HelpDeskWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(HelpDeskWebCoreModule).Assembly);
        }
