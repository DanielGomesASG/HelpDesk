...
{
    public class HelpDeskAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public HelpDeskAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
